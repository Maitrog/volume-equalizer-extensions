const themes = {
  dark: {
    ...
    "highpass-filter": "var(--dark-highpass-filter)",
    "lowpass-filter": "var(--dark-lowpass-filter)",
    text: "var(--dark-text)",
  ...
  light: {
    ...
    "highpass-filter": "var(--light-highpass-filter)",
    "lowpass-filter": "var(--light-lowpass-filter)",
    text: "var(--light-text)",
